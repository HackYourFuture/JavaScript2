...
{
  const myLast10Books = [
    'Last 10 book titles I have read',
  ];
  const idsOfBook = ['towards_to_lost_paradise', 'lightr', 'bizim_firavun', 'hayatin_icinden', 'kalbimin_efendisi', 'mesel_denizi', 'the_gulen_movement', 'sjip_en_janneke', 'bahar_nesidesi', 'sozler'];

  const detailsOfBook = [
    { id: 'towards-to-lost-paradise', title: 'Towards The Lost Paradise', language: 'English', author: 'M. F. Gulen'},
    { id: 'lemalar', title: 'Lemalar', language: 'Turkish', author: 'B. Said Nursi'},
    { id: 'bizim-firavun', title: 'Bizim Firavun', language: 'Turkish', author: 'Resit Haylamaz'},
    { id: 'hayatin-icinden', title: 'Hayatin Icinden', language: 'Turkish', author: 'Cuneyt Suavi'},
    { id: 'kalbimin-efendisi', title: 'Kalbimin Efendisi', language: 'Turkish', author: 'Salih Suruc'},
    { id: 'mesel-denizi', title: 'Mesel Denizi', language: 'Turkish', author: 'Mehmet Akar'},
    { id: 'the-gulen-movement', title: 'The Gulen Movement', language: 'English', author: 'Muhammet Cetin'},
    { id: 'jip-en-janneke', title: 'Jip en Janneke', language: 'Dutch', author: 'Annie M. G. Schmidt'},
    { id: 'bahar-nesidesi', title: 'Bahar Nesidesi', language: 'Turkish', author: 'M. F. Gulen'},
  ...
  console.log(idsOfBook + "This is for debugging and making sure everything is in order. Delete it later when you're done :");
