...
// This function will generate ul element
  ...
  const books = {
    ...
    'harry-potter-and-the-goblet-of-fire': {
      ...
      cover: 'https://upload.wikimedia.org/wikipedia/en/c/c7/Harry_Potter_and_the_Goblet_of_Fire.jpg',
      language: 'English',
      author: 'By J. K. Rowling'
    },
    'the-book-thief': {
      title: 'The Book Thief',
      cover: 'https://upload.wikimedia.org/wikipedia/en/8/8f/The_Book_Thief_by_Markus_Zusak_book_cover.jpg',
      language: 'English',
...
//https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Property_Accessors
  ...
  const listOfBooks = obj => Object.keys(obj).forEach(item => {
