...

{
  ...
  const idsOfBook = ['towards_the_lost_paradise', 'light', 'bizim_firavun', 'hayatin_icinden', 'kalbimin_efendisi', 'mesel_denizi', 'the_gulen_movement', 'sjip_en_janneke', 'bahar_nesidesi', 'sozler'];

  const detailsOfBook = [
    { id: 'towards_the_lost_paradise', title: 'Towards The Lost Paradise', language: 'English', author: 'M. F. Gulen'},
    ...
    { id: 'hayatin_icinden', title: 'Hayatin Icinden', language: 'Turkish', author: 'Cuneyt Suavi'},
    { id: 'kalbimin_efendisi', title: 'Kalbimin Efendisi', language: 'Turkish', author: 'Salih Suruc'},
    { id: 'mesel_denizi', title: 'Mesel Denizi', language: 'Turkish', author: 'Mehmet Akar'},
    { id: 'the_gulen_movement', title: 'The Gulen Movement', language: 'English', author: 'Muhammet Cetin'},
    { id: 'jip_en_janneke', title: 'Jip en Janneke', language: 'Dutch', author: 'Annie M. G. Schmidt'},
  ...
  console.log(idsOfBook + 'This is for debugging and making sure everything is in order. Delete it later when you are done :');
