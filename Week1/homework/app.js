...
const myBooks = {
  ...
  'Great Expectations': {
    ...
    plot:
      'As a young child, the orphan Pip lives with his sister and brother-in-law, the village blacksmith. On Christmas Eve, Pip is walking through the marshes when he meets an escaped convict who threatens him into bringing back food and a file to break the leg-irons.',
  },
  'Crime and Punishment': {
    ...
    plot:
      'Crime and Punishment is about the troubles of Raskolnikov, a young man living in St. Petersburg. He used to be a student, but he became so poor he had to stop studying. He plans to kill a selfish old pawnbroker for her money, and he acts on his plan.',
  },
  'Moby Dick': {
    book_info: {
      publication: 1851,
  ...
  'Jane Eyre': {
    ...
    plot:
      'Ten-year-old orphan Jane Eyre lives unhappily with her wealthy, cruel cousins and aunt at Gateshead. Her only salvation from her daily humiliations, such as being locked up in a "red-room" (where she thinks she sees her beloved uncle\'s ghost), is the kindly servant, Bessie.',
  },
  'Pride and Prejudice': {
    book_info: {
      publication: 1813,
...
const getBookInfo = () => {
  for (const key in myBooks) {
    if (Object.prototype.hasOwnProperty.call(myBooks, key)) {
      // Create li items
      const li = document.createElement('li');
      ul1.appendChild(li);
      ...
      const genderFinder = person => (person === 'female' ? 'she' : 'he');
...
window.addEventListener('load', getBookCovers);
