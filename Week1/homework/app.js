...
//step 2.4))
 ...
 function makeList() {
  ...
  for (let i = 0; i<bookTitles.length; i++) {
    ...
    let contentTitle = document.createTextNode(bookDetails[bookTitles[i]].title);
    let contentLanguage = document.createTextNode(bookDetails[bookTitles[i]].language);
    let contentAuthor = document.createTextNode(bookDetails[bookTitles[i]].Author);
