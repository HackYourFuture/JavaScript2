...
for (let i = 0; i < bookTitles.length; i++) {
    ...
    const headerTwo = document.createElement('h5');
    headerTwo.innerHTML = 'Author: ' + book.author;
    const headerThree = document.createElement('h6');
    headerThree.innerHTML = 'Language: ' + book.language;
    headerTwo.appendChild(headerThree);
