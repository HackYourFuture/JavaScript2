  ...
  */
  ...
  const information = {
    ...
    howards_end: {
      ...
      description:
        "The self-interested disregard of a dying woman's bequest, an impulsive girl's attempt to help an impoverished clerk, and the marriage between an idealist and a materialist"
    },
    robinson_crusoe: {
      author: 'Daniel Defoe',
    ...
    adventures_of_huckleberry_finn: {
      ...
      description:
        "The novel's preeminence derives from its wonderfully imaginative re-creation of boyhood adventures along the Mississippi River."
    },
    oliver_twist: {
  ...
  favoriteBooks.innerHTML = 'My Favorite Books';
