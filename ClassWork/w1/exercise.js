{
  const createForm = () => {
    ...
    const firstName = document.createElement("input");     // CREATE an HTML input element for First Name
    form.appendChild(firstName);                          // ADD input element to form
    firstName.placeholder = "First Name";  

    const lastName = document.createElement("input");     // CREATE an HTML input element for Last Name
